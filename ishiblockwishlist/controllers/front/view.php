...
class IshiBlockWishListViewModuleFrontController extends ModuleFrontController
{
	...
	public function __construct()
	{
		...
		include_once($this->module->getLocalPath().'ishiblockwishlist.php');
	}
	...
	public function initContent()
	{
		...
		$this->setTemplate('module:ishiblockwishlist/views/templates/front/view.tpl');
	}
}
